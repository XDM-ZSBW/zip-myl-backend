...
const config = {
  ...
  KEY_DERIVATION_ITERATIONS: parseInt(process.env.KEY_DERIVATION_ITERATIONS, 10) || 100000,
  KEY_ROTATION_INTERVAL_DAYS: parseInt(process.env.KEY_ROTATION_INTERVAL_DAYS, 10) || 30,

  // Device Trust Configuration
  DEVICE_TRUST_EXPIRY_DAYS: parseInt(process.env.DEVICE_TRUST_EXPIRY_DAYS, 10) || 365,
  PAIRING_CODE_EXPIRY_MINUTES: parseInt(process.env.PAIRING_CODE_EXPIRY_MINUTES, 10) || 10,
  MAX_TRUSTED_DEVICES: parseInt(process.env.MAX_TRUSTED_DEVICES, 10) || 10,
  ...
  HEALTH_CHECK_INTERVAL: parseInt(process.env.HEALTH_CHECK_INTERVAL, 10) || 30,

  // Performance Configuration
  MAX_REQUEST_SIZE: process.env.MAX_REQUEST_SIZE || '10mb',
  REQUEST_TIMEOUT: parseInt(process.env.REQUEST_TIMEOUT, 10) || 30000,
  KEEP_ALIVE_TIMEOUT: parseInt(process.env.KEEP_ALIVE_TIMEOUT, 10) || 5000,
  COMPRESSION_ENABLED: process.env.COMPRESSION_ENABLED !== 'false',

  // Security Headers Configuration
  SECURITY_HEADERS: process.env.SECURITY_HEADERS !== 'false',
  HSTS_MAX_AGE: parseInt(process.env.HSTS_MAX_AGE, 10) || 31536000,
