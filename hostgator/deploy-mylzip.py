...
def deploy():
    ...
    try:
        print('[CONNECT] Connecting to Hostgator for myl.zip deployment...')
        ...
        print('\n[UPLOAD] Uploading files to myl.zip directory...')
...
if __name__ == "__main__":
    print('[START] myl.zip deployment script starting...')
    
    success = deploy()
    
    if success:
        print('\n[SUCCESS] myl.zip deployment completed successfully!')
        print('[URL] Your site should be live at: https://myl.zip')
        print('[NOTE] If you still see redirects, clear your browser cache or try incognito mode')
        sys.exit(0)
    else:
